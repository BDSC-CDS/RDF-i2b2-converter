...
ONTOLOGY_GRAPH_LOCATION, TERMINOLOGIES_LOCATION, ONTOLOGY_NAME, DATA_GRAPHS_LOCATION, OUTPUT_TABLES, USE_DUMMY_DATESt, ALWAYS_DEEP, RDF_FORMAT, PREF_LANGUAGE, ROOT_URI, PROJECT_RDF_NAMESPACE, SUBCLASS_PRED_URI, ENTRY_CONCEPTS, BLACKLIST, TERMINOLOGY_MARKER_URI, VALUESET_MARKER_URI = (
